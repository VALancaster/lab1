...
| Ответственный         | Задача 1                               | Задача 2                              | Задача 3                                | Задача 4                                |
|-----------------------|--------------------------------------|--------------------------------------|--------------------------------------|--------------------------------------|
| **Байков Илья**       | Разработка интерфейса               | Линейная таблица на списке          | Разработка общего интерфейса таблиц | Разработка модульных тестов         |
| **Валентин Кутергин** | Линейная таблица на массиве         | Хеш-таблица с открытым перемешиванием | Упорядоченная таблица на массиве    | Финальное тестирование и отладка    |
| **Вячеслав Долов**    | Таблица на поисковом дереве (АВЛ/КЧ) | Реализация структуры полинома       | Реализация постфиксного вычисления  | Хеш-таблица со списками (метод цепочек) |
